...
- (id)initWithSyntaxTree:(CPSyntaxTree *)syntaxTree
{
    ...
    if (nil != self)
    {
        ...
        else if ([second isKindOfClass:[Zoom class]])
        {
            [self setConstrainedToZoomRange:YES];
            [self setMinimumZoom:[(Zoom *)second minimumZoom]];
            [self setMaximumZoom:[(Zoom *)second maximumZoom]];
